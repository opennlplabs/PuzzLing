...
```
Then simply run the run.py to render the server. 
``` Linux
python run.py
```
...
<div align="center">
  <img src="./scoring.png" width = "100%" height = "100%">
</div>
...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-20 11:19`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f6bf0ebf-2095-40a8-9396-f95f5a2582d9.git
$ cd f6bf0ebf-2095-40a8-9396-f95f5a2582d9
```
